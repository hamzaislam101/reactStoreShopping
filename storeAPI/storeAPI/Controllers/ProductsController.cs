...
namespace storeAPI.Controllers
{
    ...
    public class ProductsController : ControllerBase
    {
        ...
        public ProductsController(StoreContext context,TodoContext todoContext)
        {
            _context = context;
        ...
        public async Task<ActionResult<IEnumerable<Todo>>> GetTodos()
        {
            ...
            {
                newTitle = todo.Title.Split('-')[0] + (todo.Id + 1).ToString();
            }

            _todoContext.Todos.Add(new Todo() { IsCompleted = false, StatusId = 0, Title = newTitle });
