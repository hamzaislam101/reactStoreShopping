...
namespace storeAPI.Controllers
{
    ...
    public class OrderController : ControllerBase
    {
        ...
        public async Task<ActionResult<OrderVM>> GetOrder(int id)
        {
            ...
            var items = _context.OrderDetails.Where(x => x.OrderId == order.Id).ToList();

            var orderVM = new OrderVM() { Items = items, Order = order };
        ...
        public async Task<ActionResult<OrderVM>> PostOrder(OrderVM order)
        {
            ...
            return CreatedAtAction("GetOrder", new { id = order.Order.Id }, order);
        }
